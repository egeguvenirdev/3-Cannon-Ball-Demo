namespace Assets.Scripts.Water
{
    ...
    public class WaterMaterialSwitcher : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            rendererr.GetPropertyBlock(defaulPropertyBlock);
        }
        ...
        public void OnTriggerEnter(Collider collider)
        {
            if (collider.tag == "Water")
            {
                ...
                rendererr.sharedMaterial = waterMaterial;
                rendererr.SetPropertyBlock(waterPropertyBlock);
            }
        }
        ...
        public void OnTriggerExit(Collider collider)
        {
            if (collider.tag == "Water")
            {
                rendererr.sharedMaterial = diffuseMaterial;
                rendererr.SetPropertyBlock(defaulPropertyBlock);
            }
        }
    }
}
